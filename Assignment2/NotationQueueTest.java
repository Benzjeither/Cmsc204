...
public class NotationQueueTest {
	...
	double one = 1, two = 2, three =3, four = 4, five = 5, six = 6;
	...
	public void testDequeueStudent() {
		try {
			assertEquals(Double.valueOf(one), doubleQ.dequeue());
			assertEquals(Double.valueOf(two), doubleQ.dequeue());
			assertEquals(Double.valueOf(three), doubleQ.dequeue());
			//Queue is empty, next statement should cause QueueUnderFlowException
			doubleQ.dequeue();
			assertTrue("This should have caused an QueueUnderflowException", false);
		}
	...
	public void testEnqueueStudent() {
		try {
			...
			assertFalse("This should have caused an QueueOverflowException", false);
		}
	}
